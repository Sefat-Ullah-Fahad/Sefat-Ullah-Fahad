...
export default function Header() {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 header-animate-in ${
          isScrolled 
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex-shrink-0 cursor-pointer" onClick={(e) => handleScrollToSection(e, 'top')}>
              <Image
                ...
                height={40}
                priority
                 // Lighthouse Aspect Ratio Warning Fix
      ...
      {/* GSAP এর বদলে Raw CSS Animation */}
      <style jsx>{`
        .header-animate-in {
          opacity: 0;
          transform: translateY(-100px);
          animation: slideDownFade 0.8s cubic-bezier(0.215, 0.61, 0.355, 1) 0.2s forwards;
        }
